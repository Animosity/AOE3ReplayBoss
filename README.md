...
- Run AOE3ReplayBoss.exe before you begin your gaming session. It will monitor the replay folder for the gameover condition, and copy your *Record Game.age3Yrec* to the *\Savegame\ReplayBoss Archive* folder with the correct timestamp.
